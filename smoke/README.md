...
05 MAR 2020:
Thanks to Dr. Haidao Lin of GSD, we now have a one-stop script for
compiling all the executables.  Simply run ./build_HRRR_smoke.bash
/path/to/execs or ./build_RAP_smoke.bash /path/to/execs

Sam Trahan's original instructions below can still be used for
compiling individual components.
