...
!
   ...
   if(n == 1) then
      call getarg(1,cnpe)
      read(cnpe,*) npe
      write(*,*) 'read in npe =',npe
   else
      write(*,*) 'need one npe as input !'
      stop 123
   endif
   ...
   call timepe_read_stdout(iyear,imonth,iday,ihour)
...
subroutine timepe_read_stdout(iyear,imonth,iday,ihour)
  implicit none
