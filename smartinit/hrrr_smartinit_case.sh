...
DATA=/gpfs/hps3/emc/meso/save/Ming.Hu/test/smartinit
cyc=12
GRB2INDEX=/gpfs/hps/nco/ops/nwprod/grib_util.v1.0.5/exec/grb2index
COMIN=/gpfs/hps/nco/ops/com/hrrr/prod/hrrr.20180720/conus/
COMOUT=../
FIXhrrr=/gpfs/hps/nco/ops/nwprod/hrrr.v3.0.0/fix/conus
PARMhrrr=/gpfs/hps/nco/ops/nwprod/hrrr.v3.0.0/parm/conus
WGRIB2=/gpfs/hps/nco/ops/nwprod/grib_util.v1.0.5/exec/wgrib2
COMROOT=/gpfs/hps/nco/ops/com/date
EXEChrrr=/gpfs/hps/nco/ops/nwprod/hrrr.v3.0.0/exec
